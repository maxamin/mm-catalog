...
class AddTelegramNews extends Migration
{
    ...
    public function up()
    {
        $text = <<<TEXT
<p>
Команда Ex-Solaris представляет новое крупное обновление, доступное для всех тарифных планов. <br /> 
...
За дополнительной информацией и по вопросам приобретения обращайтесь к администратору Ex-Solaris через форум Darkcon или через один из жаберов, который указан ниже: <br />
<strong>Ex-Solaris@securejabber.me</strong><br />
<strong>z8888@zloy.im</strong><br />
<strong>zzzz8@exploit.im</strong><br />
<strong>Ex-Solaris_support@xmpp.co</strong>
</p>
TEXT;
