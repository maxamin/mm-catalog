        ...
        @foreach ($unreadNotifications as $notification)
            <div class="media">
                <div class="media-left" style="padding-right: 10px">
                    <img style="width: 32px" class="media-object" src="{{ asset('/assets/img/logo.svg') }}" alt="Ex-Solaris">
                </div>
                <div class="media-body">
                    <h5 class="media-heading" style="margin-bottom: 4px">
                        Ex-Solaris <span class="text-muted" style="padding-left: 10px"><i class="glyphicon glyphicon-calendar"></i> {{ $notification->created_at->format('d.m.Y') }}</span>
                    </h5>
